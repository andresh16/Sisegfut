 ...
 */
public class InformeDeportistasEstrato extends FormPanel{
    ...
    public InformeDeportistasEstrato(){
        ...
        return new SelectionListener<ButtonEvent>() {
            ...
            public void componentSelected(ButtonEvent ce) {
                ...
                if (isValid()) {
                    ...
                    String base = GWT.getModuleBaseURL() + "../html/reportes/ReporteDeportistaEstrato/";
                    // usuarioSession
