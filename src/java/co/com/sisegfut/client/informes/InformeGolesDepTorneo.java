 ...
 */
public class InformeGolesDepTorneo extends FormPanel{
    ...
    public SelectionListener<ButtonEvent> ListenerGenerarReporte(final int tipo) {
        return new SelectionListener<ButtonEvent>() {
            ...
            public void componentSelected(ButtonEvent ce) {
                ...
                if (isValid()) {
                    Long idTorneo = cbxTorneo.getTorneosElegido().getId();
                    String nombreTorneo=cbxTorneo.getTorneosElegido().getNombreTorneo();

                    String base = GWT.getModuleBaseURL() + "../html/reportes/GolesDeportistaTorneo/";
                    // usuarioSession
                    redireccionarA(base + nombreTorneo + "/"+idTorneo+"/"+ + tipo);
                   reset();
                } else {
