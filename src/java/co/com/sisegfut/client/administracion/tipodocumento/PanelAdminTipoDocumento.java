 ...
 * @author anfeh_000
 */
public class PanelAdminTipoDocumento extends Window {

    private PanelCrearTipoDocumento crear;
    private PanelModificarTipoDocumento modificar;
    private PanelInactivarTipoDocumento inactivar;
    private PanelReactivarTipoDocumento reactivar;
    ...
    public PanelAdminTipoDocumento() {
        ...
        setModal(true);
        setBlinkModal(true);
        setHeading("Administrar Tipos Documentos");
        setLayout(new FillLayout());
        setResizable(false);


        crear = new PanelCrearTipoDocumento();
        modificar = new PanelModificarTipoDocumento();
        inactivar = new PanelInactivarTipoDocumento();
        reactivar = new PanelReactivarTipoDocumento();
