 ...
 * @author Malejandro
 */
public class PanelAdminTorneos extends Window{
    
    private PanelCrearTorneos crear;
    private PanelModificarTorneos modificar;
    private PanelInactivarTorneos inactivar;
    private PanelReactivarTorneos reactivar;
    ...
    public PanelAdminTorneos() {
        ...
        setModal(true);
        setBlinkModal(true);
        setHeading("Administrar Torneos");
        setLayout(new FillLayout());
        setResizable(false);
//        setAutoHeight(true);
//        setAutoWidth(true);

        crear = new PanelCrearTorneos();
        modificar = new PanelModificarTorneos();
        inactivar = new PanelInactivarTorneos();
        reactivar = new PanelReactivarTorneos();
