 ...
 * @author anfeh_000
 */
public class PanelInactivarNivelEducativo extends LayoutContainer {
    ...
    public PanelInactivarNivelEducativo() {
    }
    ...
    public void inactivar() {
        ...
        if (panel.isValid()) {
            ...
            getServiceNivelEducativo().eliminarEntidad(cbxNivelEducativo.getNivelEducativoElegido().getId(), new AsyncCallback() {

                @Override
                public void onFailure(Throwable caught) {
                    pnlErrores.limpiar();
                    pnlErrores.setVisible(true);
                    pnlErrores.aniadir("No se Inactivo el Nivel Educativo");
                }
