 ...
 * @author anfeh_000
 */
public class PanelAdminInsEducativa extends Window {

    private PanelCrearInstEducativa crear;
    private PanelModificarInstEducativa modificar;
    private PanelInactivarInstEducativa inactivar;
    private PanelReactivarInstEducativa reactivar;
    ...
    public PanelAdminInsEducativa() {

        setSize(350, 170);
        setPlain(true);
        setModal(true);
        setBlinkModal(true);
        setHeading("Administrar Inst Educativas");
        setLayout(new FillLayout());
        setResizable(false);
//        setAutoHeight(true);
//        setAutoWidth(true);

        crear = new PanelCrearInstEducativa();
        modificar = new PanelModificarInstEducativa();
        inactivar = new PanelInactivarInstEducativa();
        reactivar = new PanelReactivarInstEducativa();
        ...
        getHeader().addTool(new ToolButton("x-tool-help", new SelectionListener<IconButtonEvent>() {
            ...
            public void componentSelected(IconButtonEvent ce) {
                abrirVentana(myConstants.ayudaPanelInstitucionEducativa());
            }
        }));
