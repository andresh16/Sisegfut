 ...
 * @author anfeh_000
 */
public class PanelInactivarInstEducativa extends LayoutContainer {
    ...
    public PanelInactivarInstEducativa() {
    }
    ...
    public void inactivar() {
        ...
        if (panel.isValid()) {
            ...
            getServiceInstEducativo().eliminarEntidad(cbxInsEducativa.getInstEducativaElegida().getId(), new AsyncCallback() {

                @Override
                public void onFailure(Throwable caught) {
                    pnlErrores.limpiar();
                    pnlErrores.setVisible(true);
                    pnlErrores.aniadir("No se Inactivo la Inst Educativa");
                }
