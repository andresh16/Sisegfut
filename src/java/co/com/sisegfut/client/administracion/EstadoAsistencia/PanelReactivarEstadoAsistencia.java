...
// * @author anfeh_000
// */
//public class PanelReactivarEstadoAsistencia extends LayoutContainer{
//    
//    FormPanel panel = new FormPanel();
//    private FormBinding formBindings;
//    private ComboBoxEstadoAsistencia cbxEstadoAsistencia;
//
//    public PanelReactivarEstadoAsistencia() {
//    }
//    
//    
//    @Override
...
//     
//        
//        cbxEstadoAsistencia=new ComboBoxEstadoAsistencia(ComboBoxEstadoAsistencia.INACTIVOS);
//        
...
//                if (panel.isValid()) {         
//                    
//                    getServiceEstadoAsistencia().reactivarEntidad(cbxEstadoAsistencia.getEstadoAsistenciaElegido().getId(), new AsyncCallback() {
//
//                       @Override
//                       public void onFailure(Throwable caught) {
//                      MessageBox.alert("Error", "No se Reactivo el Estado Asistencia", null);}
//
//                       @Override
//                       public void onSuccess                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (Object result) {
//                       MessageBox.alert("Reactivar", "Se Reactivo correctamente el Estado Asistencia", null);}
//                       
//                   });
