 ...
 * @author anfeh_000
 */
public class PanelReactivarCategoria extends LayoutContainer {
    ...
    public PanelReactivarCategoria() {
    }
    ...
    protected void onRender(Element parent, int index) {
       ...
       // 
        ...
        btnReactivar.setIcon(Resources.ICONS.iconoCrear());
    ...
    public void reactivar() {
        ...
        if (panel.isValid()) {
            ...
            getServiceCategoria().reactivarEntidad(cbxCategoria.getCategoriaElegida().getId(), new AsyncCallback() {
