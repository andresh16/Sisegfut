 ...
 * @author anfeh_000
 */
public class PanelAdminCategoria extends Window {

    private PanelCrearCategoria crear;
    private PanelModificarCategoria modificar;
    private PanelInactivarlCategoria inactivar;
    private PanelReactivarCategoria reactivar;
    ...
    public PanelAdminCategoria() {
        ...
        setModal(true);
        setBlinkModal(true);
        setHeading("Administrar Categorias");
        setLayout(new FillLayout());
        setResizable(false);
//        setAutoHeight(true);
//        setAutoWidth(true);

        crear = new PanelCrearCategoria();
        modificar = new PanelModificarCategoria();
        inactivar = new PanelInactivarlCategoria();
        reactivar = new PanelReactivarCategoria();
