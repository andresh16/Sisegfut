 ...
 * @author anfeh_000
 */
public class PanelAdminCargos extends Window {

    private PanelCrearCargos crear;
    private PanelModificarCargos modificar;
    private PanelInactivarCargos inactivar;
    private PanelReactivarCargos reactivar;
...
//        setAutoWidth(true);
        ...
        inactivar = new PanelInactivarCargos();
        reactivar = new PanelReactivarCargos();
