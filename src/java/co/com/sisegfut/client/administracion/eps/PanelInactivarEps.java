 ...
 * @author anfeh_000
 */
public class PanelInactivarEps extends LayoutContainer {
    ...
    public void inactivar() {
        ...
        if (panel.isValid()) {
            ...
            getServiceEps().eliminarEntidad(cbxEps.getEpsElegido().getId(), new AsyncCallback() {

                @Override
                public void onFailure(Throwable caught) {
                    pnlErrores.limpiar();
                    pnlErrores.setVisible(true);
                    pnlErrores.aniadir("No se Inactivo la eps");
                }
