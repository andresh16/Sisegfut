...
public class PanelAdminEps extends Window {
    ...
    private PanelCrearEps crear;
    private PanelModificarEps modificar;
    private PanelInactivarEps inactivar;
    private PanelReactivarEps reactivar;
...
//        setAutoWidth(true);
        ...
        crear = new PanelCrearEps();
        modificar = new PanelModificarEps();
        inactivar = new PanelInactivarEps();
        reactivar = new PanelReactivarEps();
