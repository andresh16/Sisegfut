 ...
 * @author anfeh_000
 */
public class PanelInactivarTipoDeportista extends LayoutContainer {
    ...
    public PanelInactivarTipoDeportista() {
    }
    ...
    public void inactivar() {
        ...
        if (panel.isValid()) {
            ...
            getServiceTipoDepotista().eliminarEntidad(cbxTipoDeportista.getTipoDeportistaElegido().getId(), new AsyncCallback() {

                @Override
                public void onFailure(Throwable caught) {
                    pnlErrores.limpiar();
                    pnlErrores.setVisible(true);
                    pnlErrores.aniadir("No se Inactivo el tipo de deportista");
                }

                @Override
                public void onSuccess(Object result) {
                    pnlExito.definirTexto("Se Inactivó correctamente el tipo de deportista");
        ...
        } else // Si hay errores
        {
            pnlErrores.limpiar();
            pnlErrores.setVisible(true);
            pnlErrores.aniadir("Debe seleccionar una tipo de deportista");
        }
