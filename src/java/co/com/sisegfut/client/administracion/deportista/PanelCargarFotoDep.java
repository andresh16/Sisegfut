 ...
 * @author fhurtado
 */
public class PanelCargarFotoDep extends Window {
    ...
    public PanelCargarFotoDep(final PanelAdminDeportista adminDeportista) {
        setSize(375, 345);
        setPlain(true);
        setModal(true);
        setBlinkModal(true);
...
//        setAutoHeight(true);
        ...
        this.panelAdminDeportista = adminDeportista;
...
//                boxWait.close();
                ...
                if (result != null && result.contains("true")) {
                    if (id > -1) {
                        ...
                        panelAdminDeportista.recargarFoto(id);
...
//        contenedorFotoUsuario.setToolTip("La foto debe tener un tamaño de 4x4");
        ...
        file.setFieldLabel("Imagen deportista");
...
//                            "Procesando los datos, por favor espere...", "Procesando...");
                    ...
                    if (file.getValue() != null && !file.getValue().isEmpty()) {
                        ...
                        if (ultimalinea.equalsIgnoreCase(".jpg") || ultimalinea.equalsIgnoreCase(".png")) {
                            base = GWT.getHostPageBaseURL() + "html/foto/cargar/" + id;
                            panel.setAction(base);
                            panel.submit();
                        } else {
//                            boxWait.close();
