...
// * @author anfeh_000
// */
//public class PanelInactivarSituacionesJuego extends LayoutContainer {
//
...
//
//    public PanelInactivarSituacionesJuego() {
//    }
//
//    @Override
...
//        if (panel.isValid()) {
//
//            getServiceSituacionesJuego().eliminarEntidad(cbxSituacionesJuego.getSituacionJuegoElegido().getId(), new AsyncCallback() {
//
//                @Override
//                public void onFailure(Throwable caught) {
//                    pnlErrores.limpiar();
//                    pnlErrores.setVisible(true);
//                    pnlErrores.aniadir("No se Inactivo la Situación de Juego");
//                }
//
//                @Override
//                public void onSuccess(Object result) {
//                    pnlExito.definirTexto("Se Inactivo correctamente la Situación de Juego");
