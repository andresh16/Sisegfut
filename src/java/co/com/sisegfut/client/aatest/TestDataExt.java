...
import co.com.sisegfut.client.aatest.model.Task;
import co.com.sisegfut.client.aatest.model.Country;
import co.com.sisegfut.client.aatest.model.Plant;
import co.com.sisegfut.client.aatest.model.Stock;
import co.com.sisegfut.client.aatest.model.Folder;
import co.com.sisegfut.client.aatest.model.State;
import co.com.sisegfut.client.aatest.model.MailItem;
import co.com.sisegfut.client.aatest.model.Music;
...
public class TestDataExt {
  ...
  public static List<Country> getCountries() {
   ...
   public static List<Tarjeta> getTarjetas() {
    ...
    tarjetas.add(new Tarjeta("ROJA"));
    tarjetas.add(new Tarjeta("AMARILLA"));
    return tarjetas;
  }

  public static List<Plant> getPlants() {
    List<Plant> plants = new ArrayList<Plant>();
    plants.add(new Plant("Bloodroot", "Mostly Shady", 2010, "03/15/2006", true));
    plants.add(new Plant("Columbine", "Shade", 2010, "03/15/2006", true));
    plants.add(new Plant("Marsh Marigold", "Mostly Sunny",2010, "05/17/2006", false));
    plants.add(new Plant("Cowslip", "Mostly Shady", 2010, "03/06/2006", true));
    plants.add(new Plant("Dutchman's-Breeches", "Mostly Shady", 2010, "01/20/2006", true));
    plants.add(new Plant("Ginger, Wild", "Mostly Shady", 2010, "04/18/2006", true));
    plants.add(new Plant("Hepatica", "Sunny", 2010, "01/26/2006", true));
    plants.add(new Plant("Liverleaf", "Mostly Sunny", 2010, "01/02/2006", true));
    plants.add(new Plant("Jack-In-The-Pulpit", "Mostly Shady", 2010, "02/01/2006", true));
    plants.add(new Plant("Mayapple", "Mostly Shady", 2010, "06/05/2006", true));
    plants.add(new Plant("Phlox, Woodland", "Sun or Shade", 2010, "01/22/2006", false));
    plants.add(new Plant("Phlox, Blue", "Sun or Shade", 2010, "02/16/2006", false));
    plants.add(new Plant("Spring-Beauty", "Mostly Shady", 2010, "02/01/2006", true));
    plants.add(new Plant("Trillium", "Sun or Shade", 2010, "04/29/2006", false));
    plants.add(new Plant("Wake Robin", "Sun or Shade", 2010, "02/21/2006", false));
    plants.add(new Plant("Violet, Dog-Tooth", "Shade", 2010, "02/01/2006", true));
    plants.add(new Plant("Trout Lily", "Shade", 2010, "03/24/2006", true));
    plants.add(new Plant("Adder's-Tongue", "Mostly Shady",2010, "02/01/2006", true));
    plants.add(new Plant("Trillium", "Shade",2010, "04/13/2006", true));
