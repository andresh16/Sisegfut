...
public class ReportesController {
    ...
    /**
     * Este es llamado por ReportesMomientos el cual hace rel reporte por
     * cuentas
     *
     * @param ncuenta
     * @param fechaInicial
     ...
     * @return
     */
//    @RequestMapping(value = "/ReporteMovimientos/{ncuenta}/{fechaInicial}/{fechaFinal}/{tipo}",
//            method = RequestMethod.GET)
//    public ModelAndView doSalesReportPDF(
//            @PathVariable Long ncuenta,
...
//
//            List<Movimientos> listaMov = daoMovimiento.BuscarMovimientosXCuenta(ncuenta, fechaInicial, fechaFinal, usuarioSession.getId());
//
//            List<DTOMovimientoXCuenta> listaMovimientos = new ArrayList<DTOMovimientoXCuenta>();
//
//            for (Movimientos movimientos : listaMov) {
//
//                DTOMovimientoXCuenta dtoMov = new DTOMovimientoXCuenta();
//
//                dtoMov.setTipoMovimiento(movimientos.getTipomov().getNombTipoMov());
//                dtoMov.setEgreso(movimientos.getEgreso().toString());
//                dtoMov.setIngreso(movimientos.getIngreso().toString());
//                dtoMov.setFechaMovimiento(Formatos.fecha2(movimientos.getFechamov()));
//                dtoMov.setCategoria(movimientos.getCategoria().getNombrecategoria());
//                dtoMov.setDescripcion(movimientos.getDescripcion());
//
//                listaMovimientos.add(dtoMov);
//
//            }
//
//            if (listaMovimientos.isEmpty()) {
//                listaMovimientos.add(new DTOMovimientoXCuenta());
//            }
//
//            Map<String, Object> parameterMap = new HashMap<String, Object>();
//
//            parameterMap.put("datasource", new JRBeanCollectionDataSource(listaMovimientos));
//            parameterMap.put("nombreCuenta", listaMov.get(0).getNcuenta().getNombrecuenta());
//            parameterMap.put("numCuenta", listaMov.get(0).getNcuenta().getNumcuenta().toString());
//            parameterMap.put("nombreUsuario", usuarioSession.getNombreCompleto());
//
//            if (tipo == TIPO_XLS) {
//                modelAndView = new ModelAndView("xlsReporteMovimiento", parameterMap);
//            } else {
//                modelAndView = new ModelAndView("pdfReporteMovimiento", parameterMap);
//            }
//
//            return modelAndView;
//
...
//
//    /**
//     * Este es llamado para realizar reportes por categoria
//     *
//     * @param ncuenta
//     * @param fechaInicial
//     * @param fechaFinal
...
//     * @return
//     */
//    @RequestMapping(value = "/reporteMovimientos2/{categoria}/{fechaInicial}/{fechaFinal}/{tipo}",
//            method = RequestMethod.GET)
//    public ModelAndView doReportPDF(
...
//            //Determino url del sistema para imagenes
//
//            List<Movimientos> listaMov = daoMovimiento.BuscarMovimientosXCategoria(categoria, fechaInicial, fechaFinal, usuarioSession.getId());
//
//            List<DTOMovimientoXCategoria> listaMovimientos = new ArrayList<DTOMovimientoXCategoria>();
//
//            for (Movimientos movimientos : listaMov) {
//
//                DTOMovimientoXCategoria dtoMov = new DTOMovimientoXCategoria();
//
//                dtoMov.setTipoMovimiento(movimientos.getTipomov().getNombTipoMov());
//                dtoMov.setEgreso(movimientos.getEgreso().toString());
//                dtoMov.setIngreso(movimientos.getIngreso().toString());
//                dtoMov.setFechaMovimiento(Formatos.fecha2(movimientos.getFechamov()));
//                dtoMov.setNombreCuenta(movimientos.getNcuenta().getNombrecuenta());
//                dtoMov.setDescripcion(movimientos.getDescripcion());
//
//                listaMovimientos.add(dtoMov);
//
...
//
//            if (listaMovimientos.isEmpty()) {
//                listaMovimientos.add(new DTOMovimientoXCategoria());
//            }
//
//            Map<String, Object> parameterMap = new HashMap<String, Object>();
//
//            parameterMap.put("datasource", new JRBeanCollectionDataSource(listaMovimientos));
//            parameterMap.put("nombreCategoria", listaMov.get(0).getCategoria().getNombrecategoria());
//            parameterMap.put("nombreUsuario", usuarioSession.getNombreCompleto());
//
//            if (tipo == TIPO_XLS) {
//                modelAndView = new ModelAndView("xlsReporteMovimiento2", parameterMap);
//            } else {
//                modelAndView = new ModelAndView("pdfReporteMovimiento2", parameterMap);
//            }
//
//            return modelAndView;
//
