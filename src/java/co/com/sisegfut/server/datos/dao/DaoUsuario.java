...
public interface DaoUsuario extends DaoGenerico<Usuarios>
{
     ...
     */
    public Usuarios getActivoByDocumento( String correo ) throws DataAccessException;
     ...
     * @throws DataAccessException
     */
    public Usuarios getActivoByDocumentoAndClave( String correo, String clave ) throws DataAccessException;
